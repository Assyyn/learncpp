...
protected:
    int m_protected{}; // can be accessed by Base members, friends, and derived
                       // classes
private:
    int m_private{}; // can only be accessed by Base members and friends (but
                     // not derived classes)
};
...
int main()
{
    ...
    base.m_protected =
        2; // not allowed: can not access protected members from outside class
    base.m_private =
        3; // not allowed: can not access private members from outside class
