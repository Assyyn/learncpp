...
class Pri : private Base // note: private inheritance
{
    ...
    // Public inherited members become private (so m_public is treated as
    // private) Protected inherited members become private (so m_protected is
    // treated as private) Private inherited members stay inaccessible (so
